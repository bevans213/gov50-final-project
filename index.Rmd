...
## Results From One Analysis: 
  ...
  I have produced 4 plots. The first shows the relationship between federal funds rates over time, the second shows the effective GDP over time (lagged for 1-2 years for accuracy), the third shows the growth rate of the GDP over time with lag accounted for, and the fourth shows the linear regression relationship between GDP and federal funds rates
  
  The plot of Interest Rates year over year show that interest rates peaked in the early 1980s, while also rising from the mean of 4.27% 6 times since 1951. These are most likely times of inflation, when the Federal Reserve rose interest rates to slow down growth and fight inflation.
...
**Results:** In my regression analysis, the main coefficient of interest was the coefficient between the federal funds rate and GDP, which came out to -356 when accounting for lag, meaning that when interest rates increase by a full point, GDP decreases by $356B. This coefficient shows a strong negative relationship between the federal funds rates and GDP.
